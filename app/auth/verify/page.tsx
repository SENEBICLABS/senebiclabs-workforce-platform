    ...
    <Card className="p-8 text-center">
      {verifying ? (
        ...
        <>
          ...
          <Link
            href="/"
            className="focusable mt-5 inline-flex h-9 items-center justify-center rounded-btn bg-accent px-4 text-[14px] font-semibold text-on-fill transition-colors hover:bg-accent-hover"
          >
            Request a new link
          </Link>
        </>
